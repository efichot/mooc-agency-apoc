  ...
  questions: [
    {
      ...
      answers: [
        {
          content:
            'A - Vérifier si la gestion du fonds atteint les objectifs fixés',
          correctAnswer: false
        },
        {
    ...
    },
    {
      ...
      answers: [
        ...
        {
          content:
            'C - La valeur de son investissement est supérieure à celle de l’indice de référence',
          correctAnswer: false
        }
      ],
      explication: {
    ...
    },
    {
      ...
      answers: [
        {
          content:
            'A - Une position plus importante dans le fonds que dans l’indice',
          correctAnswer: true
        },
        {
          content:
            'B - Une position plus importante dans l’indice que dans le fonds',
          correctAnswer: false
        },
        {
    ...
    },
    {
      ...
      answers: [
        ...
        {
          content:
            'C - La capacité du gérant à ajouter de la performance en prenant du risque ',
          correctAnswer: true
        }
      ],
      explication: {
