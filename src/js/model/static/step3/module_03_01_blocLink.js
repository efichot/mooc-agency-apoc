...
import pdf from '../../../../assets/img/step3/module_03_01_blocLink.pdf';

const module_03_01_blocLink = {
  /*position: 5,*/
  ...
  link: pdf,
  buttonName: 'Fiche fonds actions D'
};

export default module_03_01_blocLink;
