...
Seul votre classement dépend de votre rapidité à bien répondre.`,
  ...
  questions: [
    ...
    },
    {
      ...
      explication: {
        __html: `5 à 10% du fonds Amundi Label Équilibre Solidaire ESR sont investis dans les entreprises de l’économie sociale et solidaire dont l’objet principal est le soutien aux personnes fragilisées, la lutte contre les exclusions et les inégalités, l’éducation, le lien social, le développement durable, la transition énergétique ou la solidarité internationale (loi n°2014-856 du 31 juillet 2014).<br>
Le solde, soit 90 à 95% du fonds, est investi en actions d’entreprises socialement responsables, c’est-à-dire respectueuses de l’environnement, des hommes et des règles de bonne gouvernance. Le fait que le fonds soit investi pour partie en actions et pour partie en produits de taux (monétaire et obligataire) explique que son risque soit de 4.<br><br>Un autre fonds solidaire, Amundi Label Harmonie Solidaire ESR, vous est proposé dans le PERCO, mais avec un risque de 3 en raison d’une exposition aux produits de taux plus forte.`,
      },
    },
    {
      questionNumber: 1,
      question: {
        __html: `5 – Compte-tenu des bonnes perspectives du Groupe ADP, vous vous étonnez que le fonds Groupe ADP PEPS proposé dans le PEG soit plus risqué que le fonds Amundi Convictions ESR proposé dans le PERCO. Comment l’expliquer ?`,
      },
      answers: [
        {
      ...
      explication: {
        __html: `Le fonds Groupe ADP PEPS est investi exclusivement en actions du Groupe ADP. Contrairement au fonds Amundi Convictions ESR dont les investissements sont répartis sur des actions de nombreuses entreprises, son risque est concentré. Cela ne signifie pas que le fonds Groupe ADP PEPS sera moins performant que le fonds Amundi Convictions ESR ; par exemple si la croissance du Groupe ADP se révélait supérieure à celle des entreprises dont les titres sont détenus par Amundi Convictions ESR, la performance du fonds Groupe ADP PEPS pourrait même être supérieure.
Quant aux titres non cotés détenus à hauteur de 0 à 30% par Amundi Convictions ESR, ils ne réduisent pas le risque car, échangés de gré à gré entre deux parties, ils peuvent être difficiles à vendre. Ils ne bénéficient pas de la liquidité assurée par la multiplicité des investisseurs présents sur les marchés cotés.`,
    ...
    },
    {
      ...
      explication: {
        __html: `Ces deux fonds étant proposés dans le PERCO, on peut penser que votre horizon de placement est long. Vous pouvez donc accroître en proportion votre exposition aux actions qui sont aussi les actifs les plus performants à long terme, en répartissant par exemple vos investissements entre Amundi Label Harmonie Solidaire ESR et Europe Expertise Optima. <br>
En revanche, si votre durée de placement est plus réduite car vous partez prochainement à la retraite ou envisagez d’acheter votre résidence principale, votre choix va dépendre de votre profil personnel et de la perte maximale potentielle que vous seriez prêt à assumer, sachant que Europe Expertise Optima peut être 3 fois plus exposé aux actifs risqués que sont les actions, que Amundi Label Harmonie Solidaire ESR.`,
      },
    },
    {
      questionNumber: 1,
...
CPR ES Croissance investit lui aussi au niveau mondial mais sans thème particulier. Expertise Europe Optima privilégie quant à lui les marchés actions européens.`,
      },
    },
    {
      questionNumber: 1,
