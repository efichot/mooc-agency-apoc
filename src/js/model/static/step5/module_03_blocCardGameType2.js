...
export const actorscolumn3 = [
  {
    title: 'ÉRAFP*',
    help: '*Établissement pour la Retraite Additionnelle de la Fonction Publique',
    headList1: 'Besoins',
    list1: [
      {
        __html: 'Investir les sommes destinées à la retraite additionnelle des fonctionnaires',
      },
      {
  ...
  },
  {
    ...
    list1: [
      {
        __html: 'Investir les souscriptions de ses clients dans le fonds HSBC Monétaire, soit 100 millions d’euros',
      },
    ],
    headList2: 'Opérations',
    list2: [
  ...
  },
  {
    ...
    list2: [
      ...
      {
        __html: "Achat d’<em style='color: rgba(255,0,31,1.00)'>actions</em> Banca Monte Dei Paschi sur le marché",
      },
    ],
  },
  {
...
export const actorscolumn1 = [
  ...
  },
  {
    ...
    list1: [
      {
        __html: 'Se refinancer à court terme via sa filiale financière ENEL Finance',
      },
    ],
    headList2: 'Opérations',
    list2: [
  ...
  },
  {
    ...
    list2: [
      {
        __html: "Émission d'<em style='color: rgba(255,0,31,1.00)'>actions</em> de 1.5 milliards d'euros en avril 2009",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    list2: [
      {
        __html: "Émission d'<em style='color: rgba(255,0,31,1.00)'>actions</em> de 1 milliard d’euros en avril 2009",
      },
      {
        __html:
  ...
  },
  {
    ...
    list2: [
      {
        __html: "Aucune nouvelle émission d'<em style='color: rgba(255,0,31,1.00)'>actions</em>",
      },
    ],
  },
];

export const actorscolumn2 = [
  {
    title: 'Crédit agricole cheuvreux',
    headList1: 'Besoins',
    list1: [
      {
        __html: 'Exécuter les ordres d’achat de Axa et BNP Paribas Asset Management',
      },
      {
        __html: 'Se financer à court terme',
      },
  ...
  },
  {
    ...
    list2: [
      {
        __html: "Placement de l’émission en <em style='color: rgba(255,0,31,1.00)'>actions</em> de Lafarge",
      },
      {
        __html: 'Montage de l’opération réservée aux salariés de Spie Batignolles',
      },
    ],
  },
  {
