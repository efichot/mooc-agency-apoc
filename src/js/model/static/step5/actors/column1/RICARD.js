...
export default {
  ...
  firstCard: {
    ...
    list: [
      ...
      {
        __html:
          "Procède en avril 2009 à une émission d'<em style='color: var(--action)'>actions</em> de 1 milliard d'euros pour réduire l’endettement dû à l’acquisition et au ralentissement économique des Etats-Unis et de l’Europe",
      },
      {
        __html:
          "Procède en mai 2009 à une émission d'<em style='color: var(--obligation)'>obligations</em> de 800 millions d'euros pour se refinancer",
      },
    ],
  },
  secondCard: {
  ...
  thirdCard: {
    ...
    list2: [
      {
        __html: "Émission d'<em style='color: var(--action)'>actions</em> de 1 milliard d'€ en avril 2009",
      },
      {
        __html: "Émission d'<em style='color: var(--obligation)'>obligations</em> de 800 millions d'€ en mai 2009",
      },
    ],
  },
};
