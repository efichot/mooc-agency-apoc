  ...
  game: [
    ...
    },
    {
      ...
      firstCard: {
        ...
        list: [
          {
            __html: "A acquis en décembre 2007  le groupe cimentier égyptien Orascom Cement pour 8,8 milliards d'euros",
          },
          {
            __html:
    ...
    },
    {
      ...
      thirdCard: {
        ...
        list2: [
          {
            __html: "Émission d'<em style='color: rgba(255,0,31,1.00)'>actions</em> de 1 milliard d'€ en avril 2009",
          },
          {
            __html:
    ...
    },
    {
      ...
      secondCard: {
        ...
        list2: [
          {
            __html: "Emprunt <em style='color: rgba(0,159,63,1.00)'>monétaire</em>",
          },
        ],
      },
      thirdCard: {
    ...
    },
    {
      ...
      firstCard: {
        ...
        list: [
          {
            __html: 'Gère  le fonds  HSBC Monétaire pour le compte de ses clients',
          },
          {
            __html:
      ...
      thirdCard: {
        ...
        list1: [
          {
            __html: "Investir les souscriptions de ses clients dans le fonds HSBC Monétaire, soit 100 millions d'€",
          },
        ],
        headList2: 'Opérations',
        list2: [
