...
const step7 = {
  ...
  module10: {
    ...
    modulType: moduleTypes.blocDescription,
    description: `Entre les deux titres de créance négociables qui ont été échangés en 2009, lequel vous semble le plus exposé aux événements qui se sont déroulés en 2010 et 2011, sachant que tous deux sont notés par les agences de notation ?`
  },
  /*------------------------------------*/
  /*MODULE 11*/
  /*------------------------------------*/
