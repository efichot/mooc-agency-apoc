...
var tableau_info = [
  ...
  { title: "TITRES",     value : 0,   color: "black", tag:'derives'     },
	...
	{ title: "MONA",value : 0,    color: "url(#grad2)", tag:'horsmarche'  },
	{ title: "MONADONE",value : 0,    color: "url(#grad3)", tag:'horsmarche'  },
];



var steplocal=localStorage.getItem('monastep6');
...
var step=steplocal;
// 1
var done=function(){localStorage.setItem('monastep6',99);actualise();}
// 2
