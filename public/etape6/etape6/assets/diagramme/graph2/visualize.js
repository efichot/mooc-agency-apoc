...
var tableau_info = [
  { title: "MONÉTAIRE",   value : 0,  color: "black", tag:'monetaire'   },
  { title: "ACTIONS",     value:  0,    color: "black", tag:'actions'     },
  { title: "OBLIGATIONS", value:  0,   color: "black", tag:'obligations' },
  { title: "TITRES",     value : 0,   color: "black", tag:'derives'     },
    { title: "HORS MARCHÉS",value : 0,    color:"black", tag:'horsmarche'  },
	{ title: "OBAMONA",value : 0,    color: "url(#grad3)", tag:'horsmarche'  },
	{ title: "OBAMONADONE",value : 0,    color: "url(#grad2)", tag:'horsmarche'  },
];



var steplocal=localStorage.getItem('obastep6');
if(steplocal==null){steplocal=1;}
var centInit=0;
var totaltab=0;
var coeff100=0;
var step=steplocal;
// 1
var done=function(){localStorage.setItem('obastep6',99);actualise();}
// 2
