...
function gestionMenuMarche(){
	...
	if(localStorage.getItem('actionTermine')== "true"){
		...
		//Désactiver les boutons du menu et cacher le menu du bas si un marché est en cours.
	if(localStorage.getItem('actionEnCours') == "true" || localStorage.getItem('monetaireEnCours')== "true" || localStorage.getItem('obligataireEnCours')== "true"){
		$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheAction1").removeClass("boutonActive");$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheAction1").addClass("boutonDesactive");
		$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheObligataire1").removeClass("boutonActive");$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheObligataire1").addClass("boutonDesactive");
		$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheMonetaire1").removeClass("boutonActive");$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheMonetaire1").addClass("boutonDesactive");
		$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#plateaudesmarches2").hide();
	}
	//Activer les boutons et montrer le plateau2 si on a terminé un marché (ie aucun n'est en cours)
	if(localStorage.getItem('actionEnCours') == "false" && localStorage.getItem('monetaireEnCours')== "false" && localStorage.getItem('obligataireEnCours')== "false"){
		$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheAction1").removeClass("boutonDesactive");$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheAction1").addClass("boutonActive");
		$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheObligataire1").removeClass("boutonDesactive");$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheObligataire1").addClass("boutonActive");
		$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheMonetaire1").removeClass("boutonDesactive");$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("boutonMarcheMonetaire1").addClass("boutonActive");
		$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheAction2").removeClass("boutonDesactive");$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheAction1").addClass("boutonActive");
		$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheObligataire2").removeClass("boutonDesactive");$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheObligataire1").addClass("boutonActive");
		$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheMonetaire2").removeClass("boutonDesactive");$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("boutonMarcheMonetaire1").addClass("boutonActive");
		$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#plateaudesmarches2").show();
	}
	//Dans tous les cas désactiver (en haut et en bas) les boutons des marchés qui ont été terminés
	if(localStorage.getItem('monetaireTermine')== "true"){
		$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheMonetaire1").removeClass("boutonActive");$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheMonetaire1").addClass("boutonDesactive");
		$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheMonetaire2").removeClass("boutonActive");$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheMonetaire2").addClass("boutonDesactive");
	}
	if(localStorage.getItem('obligataireTermine')== "true"){
		$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheObligataire1").removeClass("boutonActive");$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheObligataire1").addClass("boutonDesactive");
		$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheObligataire2").removeClass("boutonActive");$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheObligataire2").addClass("boutonDesactive");
	}
	if(localStorage.getItem('actionTermine')== "true"){
		$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheAction1").removeClass("boutonActive");$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheAction1").addClass("boutonDesactive");
		$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheAction2").removeClass("boutonActive");$('#frame1').contents().find('#bodymaininside').children('#plateaudesmarches2').children("#boutonMarcheAction2").addClass("boutonDesactive");
	}
...
var monasyntheseshow = function(){gestionMenuMarche();parent.parent.$('#marcheCourant').contents().find('#monetairesynthese').css( "display", "block");localStorage.setItem('monetaireTermine','true');localStorage.setItem('actionEnCours','false');localStorage.setItem('obligataireEnCours','false');localStorage.setItem('monetaireEnCours','false');gestionMenuMarche();}
...
var actionsyntheseshow = function(){gestionMenuMarche();$('#bodymain').contents().find('#frame1').contents().find('#bodymaininside').children('#marcheCourant').contents().find('.actionsynthese').css('display','block');parent.parent.$('#marcheCourant').contents().find('.actionsynthese').css( "display", "block");actadonesynthese();}
...
var actatest=function(){gestionMenuMarche();actactualisestorage();testactiondrop2show();testactionvideoshow();testactionvertical2show();testactionsyntheseshow();}
...
// actualisation des localStorage
var obadonesynthese=function(){gestionMenuMarche();localStorage.setItem('obligataireTermine','true');localStorage.setItem('actionEnCours','false');localStorage.setItem('obligataireEnCours','false');localStorage.setItem('monetaireEnCours','false');gestionMenuMarche();}
...
var obatest=function(){gestionMenuMarche();obactualisestorage();testobligatairedrop2show();testobligatairevideoshow();testobligatairevertical2show();testobligatairesyntheseshow();}
