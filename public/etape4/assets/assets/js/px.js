...
function checkrep4(){
	...
	actaselect=0;monaselect=0;obaselect=0;titreselect=0;diversselect=0;Noexist=0;
	...
	else if(actaPer==50&&obaPer==30&&monaPer==10&&titrePer==10){
		NoExist=1;bigcheck=0
	}
	else{
		diversselect=1;
	}
	...
	else if{bigcheck==0&&NoExist==1){
		onscreennocongrat5();
	}
}
	
	else if((bigcheck==0&&NoExist==0){
		onscreennocongrat4();
	}
}
