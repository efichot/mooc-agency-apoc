...
// localStorage.setItem('actastep',1);
// localStorage.setItem('obastep',2);
// localStorage.setItem('divastep',0);
// localStorage.setItem('titrastep',5);
...
var tableau_info = [
  ...
  { title: "TITRES",     value : 0,   color: "#FFC900", tag:'derives'     },
    { title: "HORS MARCHÉS",value : 100,    color: "url(#grad1)", tag:'horsmarche'  },
{ title: "ACTIONDONE",value : 0,    color: "#808080", tag:'horsmarche'  },	
];



var steplocal=localStorage.getItem('divastep');
if(steplocal==null){steplocal=0;}
...
var actualise=function(){
	...
	tableau_info[5].color='url(#grad1)';
	tableau_info[5].color='url(#grad2)';
	tableau_info[4].title="FONDS DIVERSIFIÉ";
	$('#monetaireCT').hide();
	$('#monetaire').hide();
	}
	...
	tableau_info[4].color='url(#grad1)';
	tableau_info[4].title="FONDS DIVERSIFIÉ";
	$('#monetaireCT').hide();
	$('#monetaire').hide();
	}
...
<!-- FONDS ACTIONS -->	
if(step==1){
	tableau_info[0].value=10;
	tableau_info[1].value=80;
	tableau_info[2].value=5;
	tableau_info[3].value=5;
	tableau_info[4].value=0;
	$('#monetaireCT').hide();
	$('#monetaire').hide();
	}
	...
	<!-- FONDS OBLIGATAIRE -->
	if(step==2){
	tableau_info[0].value=50;
	tableau_info[1].value=5;
	tableau_info[2].value=40;
	tableau_info[3].value=5;
	tableau_info[4].value=0;
	$('#monetaireCT').hide();
	$('#monetaire').hide();
	...
	if(step==5){
	tableau_info[0].value=40;
	tableau_info[1].value=25;
	tableau_info[2].value=25;
	tableau_info[3].value=10;
	tableau_info[4].value=0;
	$('#monetaireCT').hide();
	$('#monetaire').hide();
	}
	...
	if(step==6){
	tableau_info[0].value=20;
	tableau_info[1].value=10;
	tableau_info[2].value=10;
