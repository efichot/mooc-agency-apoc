...
function checkrep4(){
	...
	if(actaselect==1&&commq1==1){bigcheck=1;$('#actioncommq1').css("border","2px solid #009C00");}
	if(monaselect==1&&commq2==1){bigcheck=1;$('#actioncommq2').css("border","2px solid #009C00");}
	if(diversselect==1&&commq3==1){bigcheck=1;$('#actioncommq3').css("border","2px solid #009C00");}
	if(titreselect==1&&commq4==1){bigcheck=1;$('#actioncommq4').css("border","2px solid #009C00");}
	if(obaselect==1&&commq5==1){bigcheck=1;$('#actioncommq5').css("border","2px solid #009C00");}
